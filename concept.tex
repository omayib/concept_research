...
\begin{document}
	...
	\begin{frame}
	\frametitle{Paper to be rebuild}
	...
	\begin{frame}
		...
		\begin{figure}
			\centering
			\includegraphics[width=1 \linewidth]{input-seq.png}
			\caption{Rebuild}			
		\end{figure}		
	\end{frame}
	...
	\begin{frame}
		...
		\begin{figure}
			\centering
			\includegraphics[height=0.7 \linewidth]{lstm-arch.JPEG}
			\caption{Rebuild}			
		\end{figure}		
	\end{frame}
	
	\begin{frame}
		\frametitle{Original vs Rebuild - LSTM}
		...
		\begin{columns}
			...
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[height=1 \linewidth]{original-lstm.png}
					\caption{Original}			
				\end{figure}		
			\end{column}
			...
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[height=1 \linewidth]{reverse-code-40hl.png}
					\caption{Rebuild}			
				\end{figure}		
			\end{column}
	...
	\begin{frame}
		\frametitle{Original vs Rebuild - LSTM}	% Begin the columns environment
		\begin{columns}
			...
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=1 \linewidth]{original-lstm-report-performance.png}
			...
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=1 \linewidth]{rebuild-report-performance.png}
					\caption{Rebuild}			
				\end{figure}		
			\end{column}
		\end{columns}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[height=1 \linewidth]{ltsm-ga.png}
					\caption{Original}			
				\end{figure}		
			\end{column}
